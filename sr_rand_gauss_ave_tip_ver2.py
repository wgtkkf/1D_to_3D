# Surface roughness generator for tip side
...
nmax = 5 # different with nxmax nor nymax
...
for i in range(0, nmax):
    f2 = open("../surface/bumpy_tip/data"+str(counter)+".txt","w")
    for j in range(0, nxmax+1): # x direction
        for k in range(0, nymax+1): # y direction

            # sigma manipulation
            cs = 2.6 # sigma coefficient

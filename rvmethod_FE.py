...
while gap < gapmax:
    ...
    for i in range(0, nxmax+1): # x direction
        for j in range(0, nymax+1): # y direction
            ...
            for k in range(0, int((division-1)*0.5)):
                ...
                # conductance & area
                total_conductance = total_conductance + area*liner_interpolate_FE(igap-h1) # [m2]*[W/m2]
    ...
    # output result
    total_conductance = (total_conductance/ucnano)/temp_dif # [nW/K]
